...
class Food:
    def __init__(self):
        ...
        colors = ["#00FFDD", "#1500ff", "#ff00ae", "#ff7b00"]
...
def next_turn(snake, food):
    ...
    square = canvas.create_rectangle(x, y, x+SPACE_SIZE, y+SPACE_SIZE, fill="#04ff00")
...
def game_over():
    ...
    msg = messagebox.askquestion("Snake Game", "Do you want to play again?")
    if msg == "no":
        window.destroy()
    else:
        # will finish it one day :PK
        canvas.delete(ALL)
